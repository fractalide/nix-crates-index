...
rec {
  ...
  flx_0_1_1 = buildCratesLib {
    name = "flx";
    version = "0.1.1";
    hash = "31fb878c6f52a1731c2b0945c76e17774268b75ceabd3d237e850579ea798b63";
    deps = with allCrates; [  all__env_logger.env_logger_0_3 all__unicode-normalization.unicode-normalization_0_1 all__log.log_0_3 ];
  };
  "flx_0_1" = flx_0_1_1;
  "flx_0" = flx_0_1_1;}