...
rec {
  tiled_0_1_0 = buildCratesLib {
    name = "tiled";
    version = "0.1.0";
    hash = "0f40b6c6829314f489e386ae0eb85da1aa9fa190c4ea2c678551b4d55a2d47ee";
    deps = with allCrates; [  all__flate2.flate2_0_0 all__rust-xml.rust-xml_0_1 ];
  };
  tiled_0_1_1 = buildCratesLib {
    name = "tiled";
    version = "0.1.1";
    hash = "e00e45768ceb5a2200ad5f0c1c0e37e4296c8d17a583a56a77dd86775e362ddd";
    deps = with allCrates; [  all__rust-xml.rust-xml_0_1 all__flate2.flate2_0_0 ];
  };
