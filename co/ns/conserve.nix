...
rec {
  ...
  conserve_0_3_2 = buildCratesLib {
    name = "conserve";
    version = "0.3.2";
    hash = "343e25558ef870730a37ba1246cd41ba115233561eeb12425d7779e30911b9c6";
    deps = with allCrates; [  all__tempfile.tempfile_2 all__rustc-serialize.rustc-serialize_0 all__log.log_0 all__brotli2.brotli2_0 all__chrono.chrono_0_2 all__tempdir.tempdir_0 all__blake2-rfc.blake2-rfc_0 all__spectral.spectral_0_6 all__error-chain.error-chain_0_7 all__term.term_0_4 all__regex.regex_0_2 all__clap.clap_2_19 all__time.time_0 all__isatty.isatty_0_1 all__vergen.vergen_0_1 all__vergen.vergen_0_1 ];
  };
  "conserve_0_3" = conserve_0_3_2;
  "conserve_0" = conserve_0_3_2;}