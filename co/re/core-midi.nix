...
rec {
  ...
  core-midi_0_1_1 = buildCratesLib {
    name = "core-midi";
    version = "0.1.1";
    hash = "17b776924e8de47e08731c5ceabe57bff238cbb60adfb00c7c6536eaed32491d";
    deps = with allCrates; [  all__core-midi-sys.core-midi-sys_0_1 all__time.time_0_1 all__core-foundation.core-foundation_0_2 ];
  };
  "core-midi_0_1" = core-midi_0_1_1;
  "core-midi_0" = core-midi_0_1_1;}