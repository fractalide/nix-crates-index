...
rec {
  ...
  google-fitness1-cli_1_0_1 = buildCratesLib {
    name = "google-fitness1-cli";
    version = "1.0.1";
    hash = "324396ddd62781e5bc3198806cee02ed234de94abeb26dd6302e0daa991e6aad";
    deps = with allCrates; [  all__serde_json.serde_json_0_8 all__yup-hyper-mock.yup-hyper-mock_1_0 all__hyper.hyper_0_9 all__mime.mime_0_2 all__serde.serde_0_8 all__clap.clap_2_0 all__strsim.strsim_0_5 ];
  };
  google-fitness1-cli_1_0_2 = buildCratesLib {
    name = "google-fitness1-cli";
    version = "1.0.2";
    hash = "7a508146ad155c1e486a90fa103c20801137151df81104aab1bbf80f4d876bc7";
    deps = with allCrates; [  all__clap.clap_2_0 all__serde_json.serde_json_0_8 all__strsim.strsim_0_5 all__yup-hyper-mock.yup-hyper-mock_1_0 all__serde.serde_0_8 all__hyper.hyper_0_9 all__mime.mime_0_2 ];
  };
  "google-fitness1-cli_1_0" = google-fitness1-cli_1_0_2;
  "google-fitness1-cli_1" = google-fitness1-cli_1_0_2;}