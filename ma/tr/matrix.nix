...
rec {
  matrix_0_0_1 = buildCratesLib {
    name = "matrix";
    version = "0.0.1";
    hash = "45242ffa27b8d0a10ccf21efb0da428fcde3f618afb95e6d407fd3db7b6f2bbf";
    deps = with allCrates; [  all__assert.assert_0_0_1 ];
  };
  matrix_0_0_2 = buildCratesLib {
    name = "matrix";
    version = "0.0.2";
    hash = "ab257a16bc60957d209c7e24e998b8e9661a92dab8f65544f76d860d26440906";
    deps = with allCrates; [  all__blas.blas_0_0_2 all__lapack.lapack_0_0_2 all__assert.assert_0_0_1 ];
  };
